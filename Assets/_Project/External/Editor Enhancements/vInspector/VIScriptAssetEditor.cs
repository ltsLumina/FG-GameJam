...
class VIScriptAssetEditor
{
    static void HeaderGUI(Editor editor)
    {
        ...
        var staticVars = classType.GetFields(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static).Where
        ...
        void saveDefaultValues()
        {
            ...
            foreach (var r in staticVars) defaultValuesByClassType[classType][r] = r.GetValue(null);
        }
