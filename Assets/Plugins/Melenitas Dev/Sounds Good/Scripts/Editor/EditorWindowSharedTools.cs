...
public class EditorWindowSharedTools : EditorWindow
{
        ...
        foreach (AudioClip clip in clips)
        {
            ...
            switch (preset)
            {
                case CompressionPreset.AmbientMusic:
                    ...
                    sampleSettings.loadType = shortDuration ? AudioClipLoadType.CompressedInMemory : AudioClipLoadType.Streaming;
                    sampleSettings.compressionFormat = shortDuration ? AudioCompressionFormat.ADPCM : AudioCompressionFormat.Vorbis;
    ...
    {
        if (banner == null) { banner = EditorGUIUtility.Load("Assets/Plugins/Melenitas Dev/Sounds Good/Graphics/Sounds Good Logo.png") as Texture2D; }
