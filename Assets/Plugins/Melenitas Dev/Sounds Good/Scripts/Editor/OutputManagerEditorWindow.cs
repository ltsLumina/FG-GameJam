...
public class OutputManagerEditorWindow : EditorWindow
{
    ...
    {
        OutputManagerEditorWindow window = (OutputManagerEditorWindow) GetWindow(typeof(OutputManagerEditorWindow));
        window.Show();
    ...
    private void GenerateEnum()
    {
        ...
        using (EnumGenerator enumGenerator = new EnumGenerator()) { enumGenerator.GenerateEnum("Output", outputNames); }
    }
